...
//    set_method(0, 1);
    ...
    fo.fd = -1;
	int result = do_compress(input_name, 0 );
    p_close(1, 1);
...
int __cdecl lzop_decompress (const char* input_name, const char* output_name)
{
    opt_cmd = CMD_DECOMPRESS;
//    set_method(0, 1);
    set_output_name(output_name, 1);
...
//    set_output_name( output_name, 1 );
    int result = do_decompress( input_name, 0 );
